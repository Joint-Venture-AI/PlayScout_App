            ...
            switch (_b.label) {
                ...
                case 1:
                    adminData = (_a.password = _b.sent(),
                        _a.role = auth_interface_1.userRoles.SUPERADMIN,
                        _a.isVerified = true,
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, database_1.myDataSource.transaction(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var userRepo, existingAdmin, adminUser;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        adminUser = userRepo.create(__assign(__assign({}, adminData), { userProfile: {
                                                fullName: "ADMIN-1",
                                                phone: "01795377643",
                                            }, authentication: {
                                                otp: null,
